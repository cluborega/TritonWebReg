...
<table border="1">
    <tr>
        ...
        <td valign="top">
            <h3>Phd Candidate List</h3>
            <p>Note:Insert new Phd Candidate</p>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    //add into graduate table
                    pstmt = conn.prepareStatement("INSERT INTO GRADUATE "+
                            "(GRADUATE_ID, GRADUATE_TYPE, MAJOR, DEPARTMENT)"+
                            " VALUES(?,?,?,?)");
                    pstmt.setString(1, (request.getParameter("ID")));
                    ...
                    //add into PHD Student table
                    pstmt = conn.prepareStatement("INSERT INTO PHDSTUDENT "+
                            " (PHDSTUDENT_ID, CANDIDATE_TYPE) VALUES (?,?)");
                    pstmt.setString(1, (request.getParameter("ID")));
                    pstmt.setString(2,(request.getParameter("CANDIDATE_TYPE")));
                    rowCount = pstmt.executeUpdate();

                    //add into CANDIDATE Table
                    pstmt = conn.prepareStatement("INSERT INTO CANDIDATE (CANDIDATE_ID,"+
                            "ADVISOR) VALUES (?,?)") ;
                    pstmt.setString(1, request.getParameter("ID"));
            ...
            <%
                ...
                ResultSet rs = statement.executeQuery
                        ("SELECT SSN,STUDENT_ID ,FIRSTNAME,MIDDLENAME,LASTNAME,"+
                                "RESIDENCY,STAT,GRADUATE_TYPE ,MAJOR,DEPARTMENT,CANDIDATE_TYPE, ADVISOR "+
                                " FROM Student,GRADUATE,PHDSTUDENT,CANDIDATE  WHERE STUDENT_ID = GRADUATE_ID " +
                                " AND GRADUATE_ID = PHDSTUDENT_ID AND PHDSTUDENT_ID = CANDIDATE.CANDIDATE_ID");
            %>
            ...
            <table border="1">
                ...
                <tr>
                    <form action="phdcandidate.jsp" method="get">
                        ...
                        <th><input value="Phd-Candiate" name="CANDIDATE_TYPE" size="15"></th>
                ...
                <tr>
                    <form action="phdcandidate.jsp" method="get">
                        ...
                        <%-- Get the Department --%>
                        <td>
                            <input value="<%= rs.getString("CANDIDATE_TYPE") %>"
                                   name="CANDIDATE_TYPE" size="15">
                        </td>
