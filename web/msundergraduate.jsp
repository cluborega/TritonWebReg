        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    //add into msundergraduate table
                    pstmt = conn.prepareStatement("INSERT INTO MSUNDERGRADUATE"+
                            "(MSUNDERGRADUATE_ID, DEPARTMENT) VALUES  (?,?)");
            ...
            <%
                ...
                ResultSet rs = statement.executeQuery
                        ("SELECT SSN,STUDENT_ID ,FIRSTNAME,MIDDLENAME,LASTNAME,"+
                                "RESIDENCY,STAT, COLLEGE, MAJOR,MINOR, DEPARTMENT FROM"+
                                " Student, UNDERGRADUATE, MSUNDERGRADUATE  WHERE STUDENT_ID = UNDERGRADUATE_ID"+
                                " AND UNDERGRADUATE_ID = MSUNDERGRADUATE_ID");
            %>
