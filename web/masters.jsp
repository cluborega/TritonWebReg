        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    //add into masters table
                    pstmt = conn.prepareStatement("INSERT INTO MASTERSTUDENT "+
                            " (MASTERSTUDENT_ID, ADVISOR) VALUES (?,?)");
                    pstmt.setString(1, (request.getParameter("ID")));
            ...
            <%
                ...
                ResultSet rs = statement.executeQuery
                        ("SELECT SSN,STUDENT_ID ,FIRSTNAME,MIDDLENAME,LASTNAME,"+
                                "RESIDENCY,STAT,GRADUATE_TYPE ,MAJOR,DEPARTMENT, ADVISOR "+
                                " FROM Student,GRADUATE,MASTERSTUDENT  WHERE STUDENT_ID = GRADUATE_ID " +
                                " AND GRADUATE_ID = MASTERSTUDENT_ID");
            %>
