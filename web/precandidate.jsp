...
<table border="1">
    <tr>
        ...
        <td valign="top">
            <h3>PhD Pre-Candidate List</h3>
            <p>Note:Insert new phd pre-candidate.</p>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    //add into PRECANDIDATE Table
                    pstmt = conn.prepareStatement("INSERT INTO PRECANDIDATE (PRECANDIDATE_ID,"+
                            "ADVISOR) VALUES (?,?)") ;
                    pstmt.setString(1, request.getParameter("ID"));
            ...
            <%
                ...
                ResultSet rs = statement.executeQuery
                        ("SELECT SSN,STUDENT_ID ,FIRSTNAME,MIDDLENAME,LASTNAME,"+
                                ...
                                " FROM Student,GRADUATE,PHDSTUDENT,PRECANDIDATE  WHERE STUDENT_ID = GRADUATE_ID " +
                                " AND GRADUATE_ID = PHDSTUDENT_ID AND PHDSTUDENT_ID = PRECANDIDATE.PRECANDIDATE_ID");
            %>
            ...
            <table border="1">
                ...
                <tr>
                    <form action="precandidate.jsp" method="get">
